...
# Time interval between simulated input actions in seconds.
var simulated_input_time_interval := 0.5
...
func _run_required_input_actions() -> void:
	...
	for action in required_input_actions:
		...
		yield(get_tree().create_timer(simulated_input_time_interval), "timeout")
