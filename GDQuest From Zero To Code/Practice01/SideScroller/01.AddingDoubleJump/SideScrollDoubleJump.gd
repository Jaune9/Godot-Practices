## Tests the implementated of double jump. This is final code, so a few
## missing lines to check understanding?
...
func _physics_process(delta: float) -> void:
	...
	# Make sure the character can only do two jumps and no more here
